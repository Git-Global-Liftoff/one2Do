...
public class UserController : Controller
{
    ...
    {
        var lists = _context
            .ListTemplates.Include(lt => lt.TaskItems)
            ...
            .Where(lt =>
                lt.ListTemplateCategories != null
                && lt.ListTemplateCategories.Any(ltc =>
                    ltc.Category.Name.Equals(category, StringComparison.OrdinalIgnoreCase)
                )
            )
            .ToList();
